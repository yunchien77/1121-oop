...
#include "../include/ElectricMotorcycle.hpp"

ElectricMotorcycle::ElectricMotorcycle()
    : ElectricVehicle() {}

ElectricMotorcycle::ElectricMotorcycle(int power)
    : ElectricVehicle(power) {}

ElectricMotorcycle::ElectricMotorcycle(int power, std::string plateNumber)
