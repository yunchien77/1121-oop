...
TEST(CheckPoint2, TestAmarettoSourGetAlcoholContentShouldReturnCorrectAlcoholContent){
...
TEST(CheckPoint2, TestAmarettoSourGetToppingShouldReturnCorrectTopping){
    ...
    ASSERT_EQ(amarettoSour.GetTopping(), std::vector<std::string>{"OrangePiece"});
}
...
TEST(CheckPoint2, TestCowboyShotGetAlcoholContentShouldReturnCorrectAlcoholContent){
...
TEST(CheckPoint2, TestCraftBeerGetAlcoholContentShouldReturnCorrectAlcoholContent){
    CraftBeer craftBeer;
...
TEST(CheckPoint2, TestFireballGetAlcoholContentShouldReturnCorrectAlcoholContent){
    Fireball fireball;
...
TEST(CheckPoint2, TestGoldschlagerGetAlcoholContentShouldReturnCorrectAlcoholContent){
...
TEST(CheckPoint2, TestHefeweizenGetAlcoholContentShouldReturnCorrectAlcoholContent){
...
TEST(CheckPoint2, TestMargaritaiGetAlcoholContentShouldReturnCorrectAlcoholContent){
    Margarita margarita;
...
TEST(CheckPoint2, TestMartiniGetAlcoholContentShouldReturnCorrectAlcoholContent){
    Martini martini;
...
TEST(CheckPoint2, TestMojitoGetAlcoholContentShouldReturnCorrectAlcoholContent){
    Mojito mojito;
...
TEST(CheckPoint2, TestTequilaGetAlcoholContentShouldReturnCorrectAlcoholContent){
    Tequila tequila;
...
TEST(CheckPoint2, TestWildfireGetAlcoholContentShouldReturnCorrectAlcoholContent){
    Wildfire wildfire;
...
TEST(CheckPoint2, TestWildfireGetToppingShouldReturnCorrectTopping){
    ...
    ASSERT_EQ(wildfire.GetTopping(), (std::vector<std::string>{"CinnamonWhiskey", "AppleJuice"}));
}
