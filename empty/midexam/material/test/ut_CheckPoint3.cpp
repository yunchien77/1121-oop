...
TEST(CheckPoint3, TestAmarettoSourSetAlcoholWithValidValueShouldChangeAlcoholContent){
...
TEST(CheckPoint3, TestAmarettoSourSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    AmarettoSour amarettoSour;
...
TEST(CheckPoint3, TestCowboyShotSetAlcoholWithValidValueShouldChangeAlcoholContent){
...
TEST(CheckPoint3, TestCowboyShotSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    CowboyShot cowboyShot;
...
TEST(CheckPoint3, TestFireballSetAlcoholWithValidValueShouldChangeAlcoholContent){
    Fireball fireball;
...
TEST(CheckPoint3, TestFireballSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    Fireball fireball;
...
TEST(CheckPoint3, TestGoldschlagerSetAlcoholWithValidValueShouldChangeAlcoholContent){
...
TEST(CheckPoint3, TestGoldschlagerSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    Goldschlager goldschlager;
...
TEST(CheckPoint3, TestMargaritaSetAlcoholWithValidValueShouldChangeAlcoholContent){
    Margarita margarita;
...
TEST(CheckPoint3, TestMargaritaSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    Margarita margarita;
...
TEST(CheckPoint3, TestMartiniSetAlcoholWithValidValueShouldChangeAlcoholContent){
    Martini martini;
...
TEST(CheckPoint3, TestMartiniSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    Martini martini;
...
TEST(CheckPoint3, TestMojitoSetAlcoholWithValidValueShouldChangeAlcoholContent){
    Mojito mojito;
...
TEST(CheckPoint3, TestMojitoSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    Mojito mojito;
...
TEST(CheckPoint3, TestTequilaSetAlcoholWithValidValueShouldChangeAlcoholContent){
    Tequila tequila;
...
TEST(CheckPoint3, TestTequilaSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    Tequila tequila;
...
TEST(CheckPoint3, TestWildfireSetAlcoholWithValidValueShouldChangeAlcoholContent){
    Wildfire wildfire;
...
TEST(CheckPoint3, TestWildfireSetAlcoholWithInvalidValueShouldThrowInvalidArgument){
    Wildfire wildfire;
