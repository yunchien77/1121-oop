...
TEST(CheckPoint2, TestReserveTicketGetReserveInfoShouldReturnCorrectReserveInfo){
    std::shared_ptr<TrainInfo> trainInfo = std::make_shared<TrainInfo>(8, 45, 75, "ZhiChang", std::vector<std::string>{"Taipei", "HsinChu", "Tainan"});
    ReserveTicketInfo reserveTicketInfo(0, 2, trainInfo);
...
TEST(CheckPoint2, TestReserveTicketWithMultipleTicketShouldReturnCorrectReserveInfo){
    std::shared_ptr<TrainInfo> trainInfo = std::make_shared<TrainInfo>(8, 45, 75, "ZhiChang", std::vector<std::string>{"Taipei", "HsinChu", "Tainan"});
