...
TEST(CheckPoint1, TestDieselEnergyGetDistanceShouldHaveCorrectDistance){
    ...
    ASSERT_EQ(dieselEnergy.GetDistance(), calculateHelper.CalculateDieselDistance(250));
}
...
TEST(CheckPoint1, TestDieselEnergyGetArrivalTimeShouldHaveCorrectArrivalTime){
    ...
    CalculateHelper calculateHelper;
    ASSERT_EQ(dieselEnergy.GetTerminalStationArrivalTimeInSecond(), calculateHelper.CalculateDieselArrivalTime(250));
}
...
TEST(CheckPoint1, TestElectricEnergyGetDistanceShouldHaveCorrectDistance){
    ...
    CalculateHelper calculateHelper;
    ASSERT_EQ(electricEnergy.GetDistance(), calculateHelper.CalculateElectricDistance(399));
}

TEST(CheckPoint1, TestElectricEnergyGetArrivalTimeShouldHaveCorrectArrivalTime){
    ElectricEnergy electricEnergy(399);

    CalculateHelper calculateHelper;
    ASSERT_EQ(electricEnergy.GetTerminalStationArrivalTimeInSecond(), calculateHelper.CalculateElectricArrivalTime(399));
}